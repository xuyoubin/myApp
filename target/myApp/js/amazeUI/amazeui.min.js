...
!function(t, e) {
    ...
    , function(t, e, i) {
        ...
        s.plugin = function(t, e, i) {
            ...
            n.fn[t] = function(o) {
                var a, r = Array.prototype.slice.call(arguments, 0), l = r.slice(1), c = this.each(function() {
                    ...
                    (d || "destroy" !== o) && (d || c.data(u, d = new e(this,p)),
                    i.methodCall ? i.methodCall.call(c, r, d) : (i.before && i.before.call(c, r, d),
                    "string" == typeof o && (a = "function" == typeof d[o] ? d[o].apply(d, l) : d[o]),
        ...
        s.template = function(t, e) {
            ...
            return i.cache[t] || (i.cache[t] = function() {
                var e = t
                  , n = /^[\w\-]+$/.test(t) ? i.get(t) : (e = "template(string)",
                t)
                  , s = 1
    ...
    , function(t, e, i) {
        ...
        l(_, C, {
            handler: function(t) {
                ...
                e & kt && 1 !== t.which && (e = Dt),
                this.pressed && this.allow && (e & Dt && (this.pressed = !1),
        ...
        window.MSPointerEvent && (Ut = "MSPointerDown",
        ...
        l(z, C, {
            handler: function(t) {
                ...
                s & St && (0 === t.button || a) ? 0 > r && (e.push(t),
                r = e.length - 1) : s & (Dt | Ft) && (i = !0),
                0 > r || (e[r] = t,
        ...
        X.prototype = {
            ...
            canEmit: function() {
                for (var t = 0; t < this.requireFail.length; ) {
                    if (!(this.requireFail[t].state & (he | oe)))
                        return !1;
                    t++
                }
                return !0
            ...
            recognize: function(t) {
                var e = a({}, t);
                return u(this.options.enable, [this, e]) ? (this.state & (ce | ue | he) && (this.state = oe),
                this.state = this.process(e),
                void (this.state & (ae | re | le | ue) && this.tryEmit(e))) : (this.reset(),
                void (this.state = he))
            },
            process: function(t) {},
        ...
        l(J, G, {
            ...
            directionTest: function(t) {
                var e = this.options
                  ...
                  , o = t.deltaX
                  , a = t.deltaY;
                return s & e.direction || (e.direction & It ? (s = 0 === o ? At : 0 > o ? $t : Mt,
                i = o != this.pX,
                n = Math.abs(t.deltaX)) : (s = 0 === a ? At : 0 > a ? Pt : Nt,
                i = a != this.pY,
                n = Math.abs(t.deltaY))),
                t.direction = s,
        ...
        l(Q, X, {
            ...
            emit: function(t) {
                this.state === ce && (t && t.eventType & Dt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = mt(),
        ...
        l(it, X, {
            ...
            emit: function() {
                this.state == ce && (this._input.tapCount = this.count,
                this.manager.emit(this.options.event, this._input))
            }
        }),
        nt.VERSION = "2.0.4",
    ...
    , function(t, e, i) {
        ...
        s.Class = function(t) {
            ...
            l) {
                ...
                this.options.debug && (s.isCompatible = !0,
                s.OS = "string" == typeof this.options.debug ? this.options.debug : "unsupported" == s.OS ? "android" : s.OS,
                s.OSVersion = "ios" == s.OS ? "8" : "4"),
                this.container = document.documentElement,
                this.session = this.getItem(this.options.appID),
                this.session = this.session ? JSON.parse(this.session) : void 0,
                !s.hasToken || s.isCompatible && this.session || (s.hasToken = !1,
                a()),
                !s.isCompatible)
                ...
                if (s.isStandalone)
                    ...
                    this.updateSession(),
                    this.options.onAdd && s.hasLocalStorage && this.options.onAdd.call(this)),
    ...
    , function(t, e, i) {
        ...
        o.prototype.setState = function(t, e) {
            ...
            s.support.animation && r.spinner && "html" === l && !this.hasSpinner && (r.loadingText = '<span class="am-icon-' + r.spinner + ' am-icon-spin"></span>' + r.loadingText,
            this.hasSpinner = !0),
            e = e || (void 0 === a[t] ? r[t] : a[t]),
            i[l](e),
            setTimeout(n.proxy(function() {
                "loadingText" === t ? (i.addClass(c).attr(o, o),
                this.isLoading = !0) : this.isLoading && (i.removeClass(c).removeAttr(o),
                this.isLoading = !1)
            }, this), 0)
        }
        ,
        o.prototype.toggle = function() {
            ...
            t && (e.toggleClass("am-active"),
            e.hasClass("am-active") || e.blur())
        }
        ,
        s.plugin("button", o, {
    ...
    , function(t, e, i) {
        ...
        ,
        s.fn.collapse = n,
        s(document).on("click.collapse.amui.data-api", "[data-am-collapse]", function(t) {
            ...
            c && c.transitioning || (d && d.find("[data-am-collapse]").not(i).addClass("am-collapsed"),
            i[l.hasClass("am-in") ? "addClass" : "removeClass"]("am-collapsed")),
            n.call(l, u)
        }),
    ...
    , function(t, e, i) {
        ...
        var n = i(1)
          ...
          , a = function(t, e) {
            ...
            this.$picker = n(r.template).appendTo("body").on({
                click: n.proxy(this.click, this)
            }),
            this.isInput = this.$element.is("input"),
            this.component = this.$element.is(".am-datepicker-date") ? this.$element.find(".am-datepicker-add-on") : !1,
            this.isInput ? this.$element.on({
                "click.datepicker.amui": n.proxy(this.open, this),
                "keyup.datepicker.amui": n.proxy(this.update, this)
            }) : this.component ? this.component.on("click.datepicker.amui", n.proxy(this.open, this)) : this.$element.on("click.datepicker.amui", n.proxy(this.open, this)),
            ...
            if (this.viewMode = this.options.viewMode,
        ...
        a.prototype.set = function() {
            ...
            this.isInput ? t = this.$element.attr("value", e) : (this.component && (t = this.$element.find("input").attr("value", e)),
        ...
        a.prototype.place = function() {
            var t = this.component ? this.component.offset() : this.$element.offset()
              ...
              , s = o.width() - t.left - e
              , a = this.isOutView();
            if (this.$picker.removeClass("am-datepicker-right"),
            this.$picker.removeClass("am-datepicker-up"),
            o.width() > 640) {
                if (a.outRight)
                    return this.$picker.addClass("am-datepicker-right"),
                    void this.$picker.css({
                        top: i,
                        left: "auto",
                        right: s
                    });
                a.outBottom && (this.$picker.addClass("am-datepicker-up"),
        ...
        a.prototype.fill = function() {
            ...
            for (var v = 0; 12 > v; )
                this.onRender(t.setFullYear(e, v), 1) && f.eq(v).addClass("am-disabled"),
                v++;
            ...
            e -= 1;
            for (var b = -1; 11 > b; b++)
                g = this.onRender(y.setFullYear(e), 2),
        ...
        a.prototype.click = function(t) {
            ...
            if (1 === l.length)
                ...
                case "span":
                    if (l.is(".am-disabled"))
                        return;
                    l.is(".am-datepicker-month") ? (e = l.parent().find("span").index(l),
                    l.is(".am-active") ? this.viewDate.setMonth(e, s.text()) : this.viewDate.setMonth(e)) : (i = parseInt(l.text(), 10) || 0,
                    l.is(".am-active") ? this.viewDate.setFullYear(i, a, s.text()) : this.viewDate.setFullYear(i)),
        ...
        a.prototype.getLocale = function(t) {
            return t || (t = navigator.language && navigator.language.split("-"),
            t[1] = t[1].toUpperCase(),
            t = t.join("_")),
            a.locales[t] || (t = "en_US"),
            t
        ...
        var r = {
            ...
            formatDate: function(t, e) {
                ...
                i.dd = (i.d < 10 ? "0" : "") + i.d,
                i.mm = (i.m < 10 ? "0" : "") + i.m;
                for (var s = 0, o = e.parts.length; o > s; s++)
                    n.push(i[e.parts[s]]);
    ...
    , function(t, e, i) {
        ...
        r.prototype.init = function() {
            return this.inited || (n(document.body).append(this.$element),
            this.inited = !0,
        ...
        r.prototype.close = function(t, e) {
            ...
            if (this.$used = this.$used.not(n(t)),
            !e && this.$used.length)
                return this;
            var s = this.$element;
    ...
    , function(t, e, i) {
        ...
        a.prototype.open = function(t) {
            ...
            if (!e.is(".am-disabled, :disabled") && !this.active) {
                ...
                o ? (this.animating = 1,
                s.addClass(this.options.animation).on(o.end + ".open.dropdown.amui", n.proxy(function() {
                    a(),
        ...
        (function(e) {
            ...
            n.flexslider = function(t, i) {
                ...
                v = {
                    init: function() {
                        ...
                        s.transitions = !s.vars.video && !m && s.vars.useCSS && function() {
                            ...
                            for (var i in e)
                                if (void 0 !== t.style[e[i]])
                                    return s.pfx = e[i].replace("Perspective", "").toLowerCase(),
                        ...
                        s.vars.keyboard && (1 === n(s.containerSelector).length || s.vars.multipleKeyboard) && n(document).bind("keyup", function(t) {
                            var e = t.keyCode;
                    ...
                    asNav: {
                        setup: function() {
                            ...
                            s.slides.each(function() {
                                ...
                                t._gesture.target = t,
                                t.addEventListener("MSPointerDown", function(t) {
                                    t.preventDefault(),
                                ...
                                t.addEventListener("MSGestureTap", function(t) {
                                    ...
                                    var e = n(this)
                                      , i = e.index();
                                    n(s.vars.asNavFor).data("flexslider").animating || e.hasClass("active") || (s.direction = s.currentItem < i ? "next" : "prev",
                                ...
                                0 >= o && e.hasClass(a + "active-slide") ? s.flexAnimate(s.getTarget("prev"), !0) : n(s.vars.asNavFor).data("flexslider").animating || e.hasClass(a + "active-slide") || (s.direction = s.currentItem < i ? "next" : "prev",
                                s.flexAnimate(i, s.vars.pauseOnAction, !1, !0, !0))
                            })
                        }
                    },
                    controlNav: {
                        ...
                        setupPaging: function() {
                            ...
                            s.pagingCount > 1)
                                for (var r = 0; r < s.pagingCount; r++) {
                                    if (e = s.slides.eq(r),
                                    t = "thumbnails" === s.vars.controlNav ? '<img src="' + e.attr("data-thumb") + '"/>' : "<a>" + o + "</a>",
                            ...
                            v.controlNav.set(),
                            v.controlNav.active(),
                            s.controlNavScaffold.delegate("a, img", c, function(t) {
                                if (t.preventDefault(),
                                "" === u || u === t.type) {
                                    var e = n(this)
                                      , i = s.controlNav.index(e);
                                    e.hasClass(a + "active") || (s.direction = i > s.currentSlide ? "next" : "prev",
                                    s.flexAnimate(i, s.vars.pauseOnAction))
                                }
                                "" === u && (u = t.type),
                        ...
                        setupManual: function() {
                            ...
                            v.controlNav.active(),
                            s.controlNav.bind(c, function(t) {
                                if (t.preventDefault(),
                                "" === u || u === t.type) {
                                    var e = n(this)
                                      , i = s.controlNav.index(e);
                                    e.hasClass(a + "active") || (i > s.currentSlide ? s.direction = "next" : s.direction = "prev",
                                    s.flexAnimate(i, s.vars.pauseOnAction))
                                }
                                "" === u && (u = t.type),
                                v.setToClearWatchedEvent()
                    ...
                    directionNav: {
                        setup: function() {
                            ...
                            s.controlsContainer ? (n(s.controlsContainer).append(t),
                            s.directionNav = n("." + a + "direction-nav li a", s.controlsContainer)) : (s.append(t),
                            s.directionNav = n("." + a + "direction-nav li a", s)),
                            v.directionNav.update(),
                            s.directionNav.bind(c, function(t) {
                                t.preventDefault();
                                var e;
                                ("" === u || u === t.type) && (e = n(this).hasClass(a + "next") ? s.getTarget("next") : s.getTarget("prev"),
                    ...
                    pausePlay: {
                        setup: function() {
                            ...
                            s.controlsContainer ? (s.controlsContainer.append(t),
                            s.pausePlay = n("." + a + "pauseplay a", s.controlsContainer)) : (s.append(t),
                            s.pausePlay = n("." + a + "pauseplay a", s)),
                            v.pausePlay.update(s.vars.slideshow ? a + "pause" : a + "play"),
                            s.pausePlay.bind(c, function(t) {
                                t.preventDefault(),
                                ("" === u || u === t.type) && (n(this).hasClass(a + "pause") ? (s.manualPause = !0,
                                s.manualPlay = !1,
                    ...
                    touch: function() {
                        function i(e) {
                            ...
                            T = e.touches[0].pageX,
                            x = e.touches[0].pageY,
                            v = p && d && s.animatingTo === s.last ? 0 : p && d ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo : p && s.currentSlide === s.last ? s.limit : p ? (s.itemW + s.vars.itemMargin) * s.move * s.currentSlide : d ? (s.last - s.currentSlide + s.cloneOffset) * g : (s.currentSlide + s.cloneOffset) * g,
                            u = h ? x : T,
                            f = h ? T : x,
                        ...
                        function n(t) {
                            ...
                            var e = 500;
                            (!b || Number(new Date) - y > e) && (t.preventDefault(),
                            !m && s.transitions && (s.vars.animationLoop || (w /= 0 === s.currentSlide && 0 > w || s.currentSlide === s.last && w > 0 ? Math.abs(w) / g + 2 : 1),
                            s.setProps(v + w, "setTouch")))
                        }
                        function o(e) {
                            if (t.removeEventListener("touchmove", n, !1),
                            s.animatingTo === s.currentSlide && !b && null !== w) {
                                var i = d ? -w : w
                        ...
                        function a(e) {
                            e.stopPropagation(),
                            s.animating ? e.preventDefault() : (s.pause(),
                        ...
                        function l(i) {
                            ...
                            if (n) {
                                ...
                                i.detail === i.MSGESTURE_FLAG_INERTIA ? void e(function() {
                                    t._gesture.stop()
                                }) : void ((!b || Number(new Date) - y > 500) && (i.preventDefault(),
                                !m && n.transitions && (n.vars.animationLoop || (w = C / (0 === n.currentSlide && 0 > C || n.currentSlide === n.last && C > 0 ? Math.abs(C) / g + 2 : 1)),
                                n.setProps(v + w, "setTouch"))))
                            }
                        }
                        function c(t) {
                            t.stopPropagation();
                        ...
                        t._slider = s,
                        t.addEventListener("MSGestureChange", l, !1),
                        t.addEventListener("MSGestureEnd", c, !1)) : t.addEventListener("touchstart", i, !1)
                    },
                    resize: function() {
                        !s.animating && s.is(":visible") && (p || s.doMath(),
                        m ? v.smoothHeight() : p ? (s.slides.width(s.computedW),
                        s.update(s.pagingCount),
                        s.setProps()) : h ? (s.viewport.height(s.h),
                        s.setProps(s.h, "setTotal")) : (s.vars.smoothHeight && v.smoothHeight(),
                ...
                s.flexAnimate = function(t, e, i, o, r) {
                    if (s.vars.animationLoop || t === s.currentSlide || (s.direction = t > s.currentSlide ? "next" : "prev"),
                    f && 1 === s.pagingCount && (s.direction = s.currentItem < t ? "next" : "prev"),
                    !s.animating && (s.canAdvance(t, r) || i) && s.is(":visible")) {
                        if (f && o) {
                            var c = n(s.vars.asNavFor).data("flexslider");
                            if (s.atEnd = 0 === t || t === s.count - 1,
                            c.flexAnimate(t, !0, !1, !0, r),
                            s.direction = s.currentItem < t ? "next" : "prev",
                            c.direction = s.direction,
                            Math.ceil((t + 1) / s.visible) - 1 === s.currentSlide || 0 === t)
                                return s.currentItem = t,
                        ...
                        e && s.pause(),
                        s.vars.before(s),
                        s.syncExists && !r && v.sync("animate"),
                        s.vars.controlNav && v.controlNav.active(),
                        p || s.slides.removeClass(a + "active-slide").eq(t).addClass(a + "active-slide"),
                        s.atEnd = 0 === t || t === s.last,
                        s.vars.directionNav && v.directionNav.update(),
                        t === s.last && (s.vars.end(s),
                        s.vars.animationLoop || s.pause()),
                        m)
                            l ? (s.slides.eq(s.currentSlide).css({
                                opacity: 0,
                                zIndex: 1
                            }),
                            s.slides.eq(t).css({
                            ...
                            p ? (u = s.vars.itemMargin,
                            w = (s.itemW + u) * s.move * s.animatingTo,
                            g = w > s.limit && 1 !== s.visible ? s.limit : w) : g = 0 === s.currentSlide && t === s.count - 1 && s.vars.animationLoop && "next" !== s.direction ? d ? (s.count + s.cloneOffset) * y : 0 : s.currentSlide === s.last && 0 === t && s.vars.animationLoop && "prev" !== s.direction ? d ? 0 : (s.count + 1) * y : d ? (s.count - 1 - t + s.cloneOffset) * y : (t + s.cloneOffset) * y,
                ...
                s.setProps = function(t, e, i) {
                    var n = function() {
                        var i = t ? t : (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo
                          , n = function() {
                            if (p)
                                return "setTouch" === e ? t : d && s.animatingTo === s.last ? 0 : d ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo : s.animatingTo === s.last ? s.limit : i;
                            switch (e) {
                            case "setTotal":
                    ...
                    s.transitions && (n = h ? "translate3d(0," + n + ",0)" : "translate3d(" + n + ",0,0)",
                ...
                s.setup = function(t) {
                    if (m)
                        ...
                        s.cloneCount = 0,
                        s.cloneOffset = 0,
                        d && (i = n.makeArray(s.slides).reverse(),
                        s.slides = n(i),
                        s.container.empty().append(s.slides))),
                        s.vars.animationLoop && !p && (s.cloneCount = 2,
                        s.cloneOffset = 1,
                        "init" !== t && s.container.find(".clone").remove(),
                        s.container.append(v.uniqueID(s.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(v.uniqueID(s.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                        s.newSlides = n(s.vars.selector, s),
                        e = d ? s.count - 1 - s.currentSlide + s.cloneOffset : s.currentSlide + s.cloneOffset,
                        h && !p ? (s.container.height(200 * (s.count + s.cloneCount) + "%").css("position", "absolute").width("100%"),
                        setTimeout(function() {
                            s.newSlides.css({
                                display: "block"
                            }),
                        ...
                        }, "init" === t ? 100 : 0)) : (s.container.width(200 * (s.count + s.cloneCount) + "%"),
                ...
                s.doMath = function() {
                    ...
                    p ? (s.itemT = s.vars.itemWidth + e,
                    s.minW = i ? i * s.itemT : s.w,
                    s.maxW = n ? n * s.itemT - e : s.w,
                    s.itemW = s.minW > s.w ? (s.w - e * (i - 1)) / i : s.maxW < s.w ? (s.w - e * (n - 1)) / n : s.vars.itemWidth > s.w ? s.w : s.vars.itemWidth,
                    ...
                    s.limit = 1 === s.pagingCount ? 0 : s.vars.itemWidth > s.w ? s.itemW * (s.count - 1) + e * (s.count - 1) : (s.itemW + e) * s.count - s.w - e) : (s.itemW = s.w,
                ...
                s.update = function(t, e) {
                    s.doMath(),
                    p || (t < s.currentSlide ? s.currentSlide += 1 : t <= s.currentSlide && 0 !== t && (s.currentSlide -= 1),
                    s.animatingTo = s.currentSlide),
                    s.vars.controlNav && !s.manualControls && ("add" === e && !p || s.pagingCount > s.controlNav.length ? v.controlNav.update("add") : ("remove" === e && !p || s.pagingCount < s.controlNav.length) && (p && s.currentSlide > s.last && (s.currentSlide -= 1,
                    s.animatingTo -= 1),
                    v.controlNav.update("remove", s.last))),
                    s.vars.directionNav && v.directionNav.update()
                }
                ,
                ...
                "object" == typeof t)
                    return this.each(function() {
                        var e = n(this)
                          ...
                          , s = e.find(i);
                        1 === s.length && t.allowOneSlide === !0 || 0 === s.length ? (s.fadeIn(400),
                        t.start && t.start(e)) : void 0 === e.data("flexslider") && new n.flexslider(this,t)
                    });
            ...
            s.ready(function(t) {
                n("[data-am-flexslider]", t).each(function(t, e) {
                    ...
                    o.before = function(t) {
                        t._pausedTimer && (window.clearTimeout(t._pausedTimer),
                        t._pausedTimer = null)
                    }
                    ,
                    o.after = function(t) {
        ...
        var s = i(2)
          ...
          , a = function() {
            ...
            e.momentum = function(t, e, i, n, s, o) {
                ...
                a = t + c * c / (2 * o) * (0 > l ? -1 : 1),
                r = c / o,
                n > a ? (a = s ? n - s / 2.5 * (c / 8) : n,
                l = Math.abs(a - t),
                r = l / c) : a > 0 && (a = s ? s / 2.5 * (c / 8) : 0,
                l = Math.abs(t) + a,
                r = l / c),
                {
            ...
            e.click = function(t) {
                var e, i = t.target;
                /(SELECT|INPUT|TEXTAREA)/i.test(i.tagName) || (e = document.createEvent("MouseEvents"),
        ...
        n.prototype = {
            ...
            _end: function(t) {
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n = (t.changedTouches ? t.changedTouches[0] : t,
                    a.getTime() - this.startTime), s = Math.round(this.x), o = Math.round(this.y), r = Math.abs(s - this.startX), l = Math.abs(o - this.startY), c = 0, u = "";
                    if (this.isInTransition = 0,
                    this.initiated = 0,
                    this.endTime = a.getTime(),
                    !this.resetPosition(this.options.bounceTime))
                        return this.scrollTo(s, o),
                        ...
                        s != this.x || o != this.y ? ((s > 0 || s < this.maxScrollX || o > 0 || o < this.maxScrollY) && (u = a.ease.quadratic),
                        void this.scrollTo(s, o, c, u)) : void this._execEvent("scrollEnd")) : (this.options.tap && a.tap(t, this.options.tap),
            ...
            _animate: function(t, e, i, n) {
                function s() {
                    ...
                    return f >= h ? (r.isAnimating = !1,
                    r._translate(t, e),
                    void (r.resetPosition(r.options.bounceTime) || r._execEvent("scrollEnd"))) : (f = (f - u) / i,
                    m = n(f),
                    d = (t - l) * m + l,
                    p = (e - c) * m + c,
                    r._translate(d, p),
    ...
    , function(t, e, i) {
        ...
        c.prototype.open = function(t) {
            ...
            if (!this.active && this.$element.length) {
                ...
                this.transitioning && (clearTimeout(e.transitionEndTimmer),
                ...
                this.dimmer.open(e),
                e.show().redraw(),
                n || this.isActions || (o && (o = parseInt(o, 10),
                r.width = o + "px",
                r.marginLeft = -parseInt(o / 2) + "px"),
                a ? (a = parseInt(a, 10),
                r.marginTop = -parseInt(a / 2) + "px",
                this.$dialog.css({
                    height: a + "px"
                })) : r.marginTop = -parseInt(e.height() / 2, 10) + "px",
                e.css(r)),
        ...
        c.prototype.events = function() {
            ...
            this.options.cancelable && i.on("keyup.modal.amui", function(t) {
                e.active && 27 === t.which && (i.trigger("cancel.modal.amui"),
                e.close())
            }),
    ...
    , function(t, e, i) {
        ...
        function n(t, e) {
            ...
            return this.each(function() {
                ...
                o || (n.data("amui.offcanvas", o = new c(this,a)),
        ...
        c.prototype.close = function(t) {
            ...
            l.length && this.active && l.hasClass("am-active") && (l.trigger("close.offcanvas.amui"),
            o.support.transition ? (setTimeout(function() {
                c.removeClass("am-offcanvas-bar-active")
            }, 0),
            r.css("margin-left", "").one(o.support.transition.end, function() {
                e()
            }).emulateTransitionEnd(this.options.duration)) : e(),
    ...
    , function(t, e, i) {
        ...
        a.prototype.sizePopover = function() {
            ...
            if (e && e.length) {
                ...
                r - g < h.top + g ? m = u.top - r - g : r < d - h.top - h.height ? (w = "bottom",
                m = u.top + c + a + g) : (w = "middle",
                m = c / 2 + u.top - n / 2),
                "top" === w || "bottom" === w ? (f = l / 2 + u.left - i / 2,
                v = f,
                5 > f && (f = 5),
                f + i > p && (f = p - i - 20),
                "top" === w && e.addClass("am-popover-top"),
                "bottom" === w && e.addClass("am-popover-bottom"),
                v -= f) : "middle" === w && (f = u.left - i - a,
                e.addClass("am-popover-left"),
                5 > f && (f = u.left + l + a,
                e.removeClass("am-popover-left").addClass("am-popover-right")),
                f + i > p && (f = p - i - 5,
                e.removeClass("am-popover-left").addClass("am-popover-right"))),
                e.css({
                    top: m + "px",
        ...
        var n = i(2)
          , s = function() {
            ...
            l.render = function(t) {
                ...
                c.showSpinner || (n = i.querySelector(c.spinnerSelector),
                n && r(n)),
    ...
    , function(t, e, i) {
        ...
        c.prototype.refreshSlides = function() {
            ...
            l && (1 === l && i.addClass(e.className.onlyOne),
            r.not("[" + c + "]").each(function(e, i) {
                var r, l;
                "A" === i.nodeName ? (r = i.href,
                l = i.title || "") : (r = n(i).data("rel") || i.src,
        ...
        c.prototype.activate = function(t) {
            ...
            l ? t.one(l.end, n.proxy(function() {
                this.transitioning = 0
    ...
    , function(t, e, i) {
        ...
        o.prototype.checkView = function() {
            ...
            i && !this.inViewState && (this.timer && clearTimeout(this.timer),
            this.initInView || (t.addClass(e.className.init),
            ...
            !i && this.inViewState && e.repeat && (t.removeClass(e.className.inView + n),
            this.inViewState = !1,
        ...
        o.prototype.process = function() {
            ...
            i.length) {
                ...
                if (n.each(i, function(e, i) {
                    return n(i).offset().top >= t ? (r = n(i),
                    !1) : void 0
                }),
                !r)
                    return;
                e.closest ? (o.closest(e.closest).removeClass(e.className.active),
                o.filter('a[href="#' + r.attr("id") + '"]').closest(e.closest).addClass(e.className.active)) : o.removeClass(e.className.active).filter('a[href="#' + r.attr("id") + '"]').addClass(e.className.active)
            }
        }
        ,
    ...
    , function(t, e, i) {
        ...
        var o = function(t, e) {
            this.$element = n(t),
            this.options = n.extend({}, o.DEFAULTS, {
        ...
        o.prototype.setChecked = function(t) {
            ...
            if (this.multiple) {
                ...
                if (!s && this.maxChecked <= o)
                    return this.$element.trigger("checkedOverflow.selected.amui", {
                        selected: this
                    }),
                    !1
            } else {
        ...
        o.prototype.syncData = function(t) {
            ...
            t) {
                ...
                this.$originalOptions.not(o).prop("selected", !1);
        ...
        l.prototype.init = function() {
            if (!this.inited) {
                ...
                r.on("click.share.amui", e, n.proxy(function(t) {
                    ...
                    "mail" !== o && "sms" !== o && (t.preventDefault(),
                    this.shareTo(o, this.setData(o))),
                    this.close()
                }, this)),
                this.inited = !0
            }
        ...
        l.prototype.setData = function(t) {
            if (t) {
                ...
                if (s.test(t) && !n.length) {
                    for (var o = a.images, r = 0; r < o.length && 10 > r; r++)
    ...
    , function(t, e, i) {
        function n(t) {
            return 128 > t ? [t] : 2048 > t ? (c0 = 192 + (t >> 6),
            c1 = 128 + (63 & t),
            [c0, c1]) : (c0 = 224 + (t >> 12),
            c1 = 128 + (t >> 6 & 63),
            c2 = 128 + (63 & t),
        ...
        var c = i(1)
          ...
          , d = function(t) {
            ...
            if (i == n && (e = new o(this.options.text,this.options.correctLevel),
            h.push({
        ...
        o.prototype = {
            ...
            setupPositionProbePattern: function(t, e) {
                for (var i = -1; 7 >= i; i++)
                    if (!(-1 >= t + i || this.moduleCount <= t + i))
                        for (var n = -1; 7 >= n; n++)
                            -1 >= e + n || this.moduleCount <= e + n || (i >= 0 && 6 >= i && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == i || 6 == i) || i >= 2 && 4 >= i && n >= 2 && 4 >= n ? this.modules[t + i][e + n] = !0 : this.modules[t + i][e + n] = !1)
            },
                ...
                for (var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
                    for (var i = 0; i < t.length; i++) {
                        ...
                        if (null == this.modules[n][s])
                            for (var o = -2; 2 >= o; o++)
                                for (var a = -2; 2 >= a; a++)
                                    -2 == o || 2 == o || -2 == a || 2 == a || 0 == o && 0 == a ? this.modules[n + o][s + a] = !0 : this.modules[n + o][s + a] = !1
                    }
            },
            ...
            createData: function() {
                ...
                for (var i = 0, n = this.utf8bytes.length; n > i; i++)
            ...
            getLostPoint: function(t) {
                for (var e = t.getModuleCount(), i = 0, n = 0, s = 0; e > s; s++)
                    for (var o = 0, a = t.modules[s][0], r = 0; e > r; r++) {
                        var l = t.modules[s][r];
                        if (e - 6 > r && l && !t.modules[s][r + 1] && t.modules[s][r + 2] && t.modules[s][r + 3] && t.modules[s][r + 4] && !t.modules[s][r + 5] && t.modules[s][r + 6] && (e - 10 > r ? t.modules[s][r + 7] && t.modules[s][r + 8] && t.modules[s][r + 9] && t.modules[s][r + 10] && (i += 40) : r > 3 && t.modules[s][r - 1] && t.modules[s][r - 2] && t.modules[s][r - 3] && t.modules[s][r - 4] && (i += 40)),
                        e - 1 > s && e - 1 > r) {
                            var c = 0;
                            l && c++,
                            t.modules[s + 1][r] && c++,
        ...
        a.prototype = {
            ...
            mod: function(t) {
                ...
                if (0 > e - i)
                    return this;
                for (var n = new Array(e), s = 0; e > s; s++)
                    n[s] = this.get(s);
                for (; n.length >= i; ) {
    ...
    , function(t, e, i) {
        ...
        c.prototype.open = function(t) {
            ...
            if (t = "number" == typeof t ? this.$navs.eq(i) : s(t),
            t && t.length && !this.transitioning && !t.parent("li").hasClass(e)) {
                ...
                t.trigger(c),
                c.isDefaultPrevented() || (this.activate(t.closest("li"), n),
        ...
        c.prototype.activate = function(t, e, i) {
            ...
            t.addClass(n),
            a ? (t.redraw(),
            t.addClass("am-in")) : t.removeClass("am-fade");
    ...
    , function(t, e, i) {
        ...
        var n = i(1)
          ...
          , o = function(t, e) {
            this.options = n.extend({}, o.DEFAULTS, e),
            this.options.patterns = n.extend({}, o.patterns, this.options.patterns);
        ...
        o.prototype.init = function() {
            ...
            var i = this
              , o = this.$element
              , a = this.options;
            return a.H5validation && s.support.formValidation ? !1 : (o.attr("novalidate", "novalidate"),
            ...
            o.on("submit.validator.amui", function(t) {
                if ("function" == typeof a.submit)
                    return a.submit.call(i, t);
        ...
        o.prototype.validate = function(t) {
            ...
            if (s.debug && window.console && (console.log("Validate: value -> [" + h + ", regex -> [" + l + "], required -> " + d),
            console.log("Regex test: " + l.test(h) + ", Pattern: " + r)),
            !isNaN(p) && h.length > p && (g.valid = !1,
            g.tooLong = !0),
            !isNaN(m) && h.length < m && (g.valid = !1,
            g.customError = "tooShort"),
            !isNaN(f) && Number(h) < f && (g.valid = !1,
            g.rangeUnderflow = !0),
            !isNaN(v) && Number(h) > v && (g.valid = !1,
            g.rangeOverflow = !0),
            d && !h)
                g.valid = !1,
                g.valueMissing = !0;
                ...
                !isNaN(w) && w > h && (g.valid = !1,
                g.customError = "checkedUnderflow"),
                !isNaN(y) && h > y && (g.valid = !1,
                g.customError = "checkedOverflow")
            } else
                r && !l.test(h) && h && (g.valid = !1,
                g.patternMismatch = !0);
            var b, T = function(t) {
                this.markField(t);
            ...
            if ("function" == typeof s.validate && (b = s.validate.call(this, g)),
            b) {
        ...
        o.prototype.getValidationMessage = function(t) {
            ...
            n.each(t, function(t, i) {
                return "field" === t || "valid" === t ? t : "customError" === t && i ? (e = i,
                s = s.customError,
                !1) : i === !0 ? (e = t,
                !1) : void 0
            }),
        ...
        var n = i(2)
          , s = {
            get: function(t) {
                ...
                return n > -1 && (e = document.cookie.indexOf(";", n),
                -1 == e && (e = document.cookie.length),
                s = decodeURIComponent(document.cookie.substring(n + i.length, e))),
                s
            },
    ...
    , function(t, e, i) {
        ...
        a.prototype.watch = function(t) {
            if (o && (t = n.extend({}, this.options, t),
            n.isFunction(t.done))) {
                this.clearWatch();
        ...
        a.prototype.clearWatch = function() {
            o && this.watchID && (o.clearWatch(this.watchID),
            this.watchID = null)
        }
        ,
        ...
        function n() {
            ...
            t.each(function(t, i) {
                ...
                a.on("click.accordion.amui", function() {
                    ...
                    !n.multiple && s(i).children(".am-active").not(o).not(e.disabled).removeClass("am-active").find(e.body + ".am-in").collapse("close"))
                })
            })
        }
        var s = i(1)
            ...
            s(".am-figure").each(function(t, e) {
                ...
                if (n.pureview)
                    if ("auto" === n.pureview) {
                        ...
                        a.addClass("am-figure-zoomable").pureview();
                i = a.data("amui.pureview"),
                i && a.on("click", ":not(img)", function() {
                    i.open(0)
                })
            })
        }
    ...
    , function(t, e, i) {
        ...
        function n() {
            ...
            s('[data-rel="desktop"]').on("click", function(t) {
                t.preventDefault(),
                window.AMPlatform ? window.AMPlatform.util.goDesktop() : (r.set("allmobilize", "desktop", "", "/"),
    ...
    , function(t, e, i) {
        ...
        function n() {
            s('[data-am-widget="header"]').each(function() {
                return s(this).hasClass("am-header-fixed") ? (s("body").addClass("am-with-fixed-header"),
                !1) : void 0
            })
        }
        var s = i(1)
        ...
        var a = function() {
            ...
            t.filter(".am-menu-one").each(function(t) {
                ...
                l.on("click", function() {
                    ...
                    (a ? u.left + u.width > h.left + h.width : u.left < h.left) && (o = r.offset(),
                    c.scrollTo(a ? h.width - u.left + o.left - u.width - d : o.left - u.left, 0, 400)),
                    e = n(this).index()
                }),
    ...
    , function(t, e, i) {
        ...
        function n() {
            ...
            function e() {
                return i() >= d ? (b.hide(),
                void y.find("li").insertBefore(b)) : (!n.find(".am-navbar-actions").length && t(),
                b.show(),
                void (u.find("li").length < i() ? y.find("li").slice(0, i() - u.find("li").length).insertBefore(b) : u.find("li").length > i() && (y.find("li").length ? u.find("li").not(b).slice(i() - 1).insertBefore(y.find("li").first()) : u.find("li").not(b).slice(i() - 1).appendTo(y))))
            }
            function i() {
            ...
            if (n.length) {
                ...
                if ("fixed" == n.css("position") && c.addClass("am-with-fixed-navbar"),
                g.length) {
